...
def load_datasets():
    datasets = {
        "DYNABENCH": load_dataset('datasets/processed_DYNABENCH.csv'),
        "MHS": load_dataset('datasets/processed_MHS.csv'),
        "DAVIDSON": load_dataset('datasets/processed_DAVIDSON.csv'),
        "MLMA": load_dataset('datasets/processed_MLMA.csv'),
    }
    return datasets
